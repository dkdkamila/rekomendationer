...
export default function RecommendationForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://brave-ileane-dominika-7b326c49.koyeb.app/api/recommendations", formData);
      setSubmitted(true);
  ...
  return (
    ...
    <div className="card shadow-lg p-4 w-100" style={{ maxWidth: "500px" }}>
      <div className="text-center mb-3">
            ...
            <g id="Image">
                <g id="g14">
                    <g id="g16">
                        ...
                        <g id="g38">
                            <path id="path40" d="M595.195 76.2172L623.725 149.709L684.511 114.948L595.195 76.2172Z"
                                fill="#FAFAFA" />
                        </g>
                        <g id="g42">
                            <path id="path44" d="M595.195 76.2172L651.26 133.962L666.528 125.232L595.195 76.2172Z"
                                fill="#DADADA" />
                        </g>
                        <g id="g46">
                            <path id="path48" d="M666.528 125.231L655.896 151.885L651.262 133.962L666.528 125.231Z"
                                fill="#DADADA" />
                        </g>
                        <g id="g50">
                            <path id="path52" d="M655.896 151.885L642.776 138.814L651.262 133.962L655.896 151.885Z"
                                fill="#B2B2B2" />
                        </g>
                        <g id="g54">
                            <path id="path56"
                        ...
                        <g id="g62">
                            <path id="path64" d="M107.952 308.508C121.544 366.877 153.477 420.713 197.968 460.267"
                        ...
                        <g id="g70">
                            <path id="path72" d="M633.861 349.129C617.182 393.899 586.452 433.173 547.233 459.836"
                                stroke="#00BBBF" stroke-width="1.612" stroke-miterlimit="10" />
                        </g>
                        <g id="g74">
                            <path id="path76" d="M198.233 424.458C213.177 349.774 197.247 269.251 155.048 206.17"
                        ...
                        <g id="g114">
                            <path id="path116" d="M546.285 450.207C530.11 375.786 544.71 295.004 585.861 231.219"
                                stroke="#11ABBA" stroke-width="2.541" stroke-miterlimit="10" />
                        </g>
                        <g id="g118">
                            <path id="path120"
                        ...
                        <g id="g158">
                            <path id="path160" d="M194.298 545.299C131.158 507.676 73.43 460.749 23.4922 406.451"
                        ...
                        <g id="g166">
                            <path id="path168" d="M558.719 549.691C601.746 514.86 639.767 473.689 671.212 427.878"
        ...
        <h2 className="text-center mb-4">Referenser</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <textarea name="text" value={formData.text} onChange={handleChange} className="form-control" rows="4" required></textarea>
          </div>
